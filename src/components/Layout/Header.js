                                ...
                                <nav className="menu-nav">
                                        ...
                                        <ul className="navigation">
                                            <li className="active ">
                                                ...
                                                {/* <ul className="sub-menu">
                                                    <li className="active"><Link to="/">Creative Agency</Link></li>
                                                    <li><Link to="/index-2">Personal Portfolio</Link></li>
                                                    <li><Link to="/index-3">Digital Agency</Link></li>
                                                </ul> */}
                                            </li>
                                    ...
                                    <div className="header-action">
                                        <ul className="list-wrap">
                                            <li className="header-btn"><Link to="/contact" className="btn">Contact <span /></Link></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                                                ...
                                                <ul className="list-wrap">
                                                    <li>
                                                        ...
                                                        <div className="content">
                                                            <Link to="mailto:company@gmail.com">company@gmail.com</Link>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                        ...
                                        <div className="col-xl-8 col-lg-7 col-md-6">
                                            <div className="our-best-project">
                                                <div className="content">
                                                    ...
                                                    <Link to="/project-details" className="btn">Details <span /></Link>
                                                </div>
                                                <div className="thumb">
                            ...
                            <div className="col-lg-4">
                                <div className="customer-support-wrap">
                                    ...
                                    <div className="customer-support-content">
                                        ...
                                        <p>We offer solutions for businesses of all sizes. For questions about our plans and products, contact our team of experts. <Link to="/contact">Get in touch</Link></p>
                                    </div>
