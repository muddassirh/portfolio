...
const Portfolio = () => {
    return (
          <>
            <div className='banner-back w-full text-white py-20'><h2 className='font-normal uppercase text-center leading-[28px] md:leading-[55px] text-[30px] md:text-[60px]'>{info.portfoliohead}</h2> </div>
