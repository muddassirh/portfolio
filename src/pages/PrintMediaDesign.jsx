...
function PrintMediaDesign() {
  return (
    <Layout breadcrumbTitle="Print Media Design Services" breadcrumbCls=" breadcrumb-area-two pt-175">
               ...
               <div className="container-sm mx-auto mb-12">
                <div className="columns-1 justify-content-center ">
                    <div className="">
                        ...
                        <span className="sub-title">Print Media Design</span>
                            <h2 className="text-[1.5rem] md:text-4xl">Fold, Cut, Repeat - Crafting Unique Print Experiences</h2>
                            <p className='text-lg'>In the digital age, print media still holds a unique power to captivate and engage. At Genxsmedia Services, we believe that effective print design is more than just aesthetics; it's a strategic tool to leave a lasting impression on your audience.</p>
                        </div>
                    ...
                    <div className="col-lg-6">
                        <div className="">
                            <div className="flex flex-col gap-y-4 mb-2">
                                ...
                                <h2 className="text-[1.5rem] md:text-[2.5rem] font-light">Why Choose <span className='text-[#3482FF] font-semibold'> Genxsmedia Services </span> for Your Print Media Design?</h2>
                            </div>
                            <div className="w-16">
                            ...
                            <div className='text-gray-600 font-light'>
                                ...
                                <p>
                                Our print media services are your ideal choice for a variety of reasons. We offer a unique blend of creativity, technical expertise, and a deep understanding of the power of print. Our team of skilled designers consistently delivers high-quality work that not only looks visually stunning but also effectively communicates your message to your target audience. With a focus on attention to detail, client satisfaction, and timely delivery, we are committed to providing exceptional print solutions that help you achieve your goals.
                                </p>                                                             
                            </div>
                        </div>
                    </div>
...
export default PrintMediaDesign